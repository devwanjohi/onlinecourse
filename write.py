...
def write_learners():
    ...
    learner_john.save()
    learner_paul = Learner(first_name='Paul', last_name='Maina', dob=date(1998, 8, 13),
                           occupation='developer',
                           social_link='https://www.linkedin.com/paul/')
    learner_paul.save()
    learner_edward = Learner(first_name='Edward', last_name='Maina', dob=date(1998, 8, 13),
                           occupation='developer',
                           social_link='https://www.linkedin.com/edward/')
